<div class="downloadlabel hide" id="downloadlabel"><?php echo $this->lang->line('join').' '.$this->lang->line('list'); ?></div>
    ...
    ?>
    <table class="table table-hover table-striped table-bordered ViewData" data-export-title="<?php echo $this->lang->line('invited')." ".$this->lang->line('staff')?> ">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td><?php echo $viewer_value->staff_name . " " . $viewer_value->staff_surname; ?></td>
