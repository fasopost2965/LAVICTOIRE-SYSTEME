            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('onlinecourse/courseexam/evalution/' . $id) ?>" method="post" class="row mb10" id="search_form">
                            <?php echo $this->customlib->getCSRF(); ?>
                            <input type="hidden" name="onlineexam_id" value="<?php echo $id; ?>">
                            <div>
        ...
        Posts: function () {
            ...
            this.ajax_get_items_pagination = function (page) {
                if ($(".pagination-container").length) {
                    ...
                    var data = {
                        action: base_url + "onlinecourse/courseexam/getDescQues",
                        data: JSON.parse($('form.post-list input').val())
                    };

                    $.ajax({
                        url: base_url + "onlinecourse/courseexam/getDescQues",
                        type: 'POST',
                        data: data,
                        beforeSend: function () {
