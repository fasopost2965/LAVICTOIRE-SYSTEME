...
$total_processing_charge += $value['gateway_processing_charge'];
                                  ...
                                  <?php } ?>
                                    ...
                                    <tr class="paybtngray">
                                      ...
                                      <td class="text-right"><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_twocheckout'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                  </tr>    
                                </table>
                                </form>
                            </div>
