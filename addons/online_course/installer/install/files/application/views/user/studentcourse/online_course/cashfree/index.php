                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/cashfree/pay" method="post">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <input type="text" name="phone" class="form-control" value="<?php echo set_value('phone',$params['contact_no']); ?>"> <span class="alert-danger"><?php echo form_error('phone'); ?></span>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td class="font-weight-bold">
                                      ...
                                      <td>
                                        <input type="email" name="email" class="form-control" value="<?php echo set_value('email',$params['email']); ?>"> <span class="alert-danger"><?php echo form_error('email'); ?></span>
                                      </td>
                                    </tr> 
