...
<html lang="en">
    <head>
        <title>online_course_exam_print --r</title>
              ...
              <div class="col-md-4">
               ...
               <div class="col-md-4">
                <div><span class="font-weight-bold"><?php echo $this->lang->line('father_name'); ?>: </span> <?php echo $student['father_name']; ?>
                  ...
                  <div class="row clear">
                        <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                              <div><span class="font-weight-bold"><?php echo $this->lang->line('total_questions') ?>: </span> <?php echo $question_type->total_quetions; ?></div>
                              <div><span class="font-weight-bold"> <?php echo $this->lang->line('descriptive_questions') ?>: </span> <?php echo $question_type->total_descriptive; ?></div>
                              <?php
                ...
                <div class="row clear">
                    ...
                    <div class="col-md-4"><span class="font-weight-bold"> <?php echo $this->lang->line('total_exam_marks') ?>: </span></div>
                    <div class="col-md-4"><span class="font-weight-bold"><?php echo $this->lang->line('total_negative_marks') ?>: </span></div>
                    <div class="col-md-4"><span class="font-weight-bold"><?php echo $this->lang->line('total_scored_marks') ?>:</span></div>
                    <div class="col-md-4"><span class="font-weight-bold"><?php echo $this->lang->line('score'); ?> (%):</span></div>
                  ...
                  <div class="row clear">
                     <div class="col-xs-12 col-md-12 section-box">
                        <div>
                           <p>
                              <span class="font-weight-bold"><?php echo $this->lang->line('q'); ?></span>
                               <span class="text text-danger">
                                <?php echo $this->lang->line('marks') ?>:()
                                <?php       ?>
                                <?php echo $this->lang->line('negative_marks') ?>:()
                                <?php  ?></span>
                           </p>
                           <p>
