                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered example"  data-export-title="<?php echo $this->lang->line('live_class'); ?>"   
>
                                <thead>
                                    <tr>
...
if ($conference_value->status == 0) {
            ?>
                    ...
                    <?php if($role != 'parent'){ ?>
                        ...
                        <a data-placement="top" title="<?php echo $this->lang->line('join') ?>" href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal-chkstatus" data-id="<?php echo $conference_value->id; ?>"> <i class="fa fa-video-camera"></i>  </a>
                        
                    <?php }else{ if($conference_setting->parent_live_class){ ?>
