                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i
                                class="fa fa-search"></i><?php echo $this->lang->line('live_meeting'); ?></h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('live_meeting', 'can_add')) {
                            ?>
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#modal-online-timetable"><i class="fa fa-plus"></i>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered example"
                                data-export-title="<?php echo $this->lang->line('live_meeting');?>">
                                <thead>
                                    <tr>
                                        <th><?php echo $this->lang->line('meeting') . ' ' . $this->lang->line('title'); ?>
                                        </th>
                                        <th width="20%"><?php echo $this->lang->line('description'); ?></th>
                                        <th><?php echo $this->lang->line('date_time'); ?></th>
                                        <th width="10%"><?php echo $this->lang->line('meeting_duration_minutes'); ?>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-date pull-right relative" width="100">
                                            ...
                                            <a data-placement="top" href="#"
                                                ...
                                                data-id="<?php echo $conference_value->id; ?>" title="<?php echo $label_display; ?>">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <?php echo $this->lang->line('add') . ' ' . $this->lang->line('live_meeting') ?> </h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            <div class="row">
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <label
                                        for="title"><?php echo $this->lang->line('meeting') . ' ' . $this->lang->line('title') ?>
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <label for="date"><?php echo $this->lang->line('meeting_date_time') ?> <small
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <label for="duration"><?php echo $this->lang->line('meeting_duration_minutes'); ?>
                                        <small class="req"> *</small></label>
                                ...
                                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <label for="class"><?php echo $this->lang->line('client_video'); ?><small
                                            class="req"> *</small></label>
                                    <div class="material-switch">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <label
                                class="label15"><?php echo $this->lang->line('staff') . ' ' . $this->lang->line('list') ?>
                                <small class="req"> *</small> </label>
                            <div class="staffmain">
                                <ul class="liststaff">
                                    <?php
                                    ...
                                    <li class="list-group-item">
                                        <div class="checkbox">
                                            <label for="staff_<?php echo $staff_value['id']; ?>">
                                                <input type="checkbox" id="staff_<?php echo $staff_value['id']; ?>"
                                                    value="<?php echo $staff_value['id']; ?>" name="staff[]">
                                                <?php
...
(function($) {
    ...
    $(document).on('click', 'a.join-btn', function(e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res.status == 0) {} else if (res.status == 1) {
    ...
    $('#modal-online-timetable').on('hidden.bs.modal', function() {
        $(this).find("input,textarea,select").not("input[type=radio]").not("input[type=checkbox]")
            .val('')
            .end();
