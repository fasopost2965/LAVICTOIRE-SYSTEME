                            ...
                            <table class="table table-hover table-striped table-bordered mintable-w900 example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="15%"><?php echo $this->lang->line('class'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="mailbox-name"><?php echo $conference_value->duration; ?></td>
                                        <td class="mailbox-name">
                                        ...
                                        <td class="mailbox-name">
                                            ...
                                            <?php
                                                    if ($conference_value->created_id == $logged_staff_id) {
                                                        ...
                                                        echo $name . " (" . $conference_value->for_create_role_name . " : " . $conference_value->create_by_employee_id . ")";
...
<div class="modal fade" id="modal-online-timetable" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="clearfix"></div>
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            <label for="class"><?php echo $this->lang->line('role'); ?> <small class="req">
                                    *</small></label>
