    ...
    if ($type == "staff") {
        ?>
         <div class="table-responsive">
            <table class="table table-hover table-striped table-bordered ViewData" data-export-title="<?php echo $this->lang->line('join_list'); ?>">
                <thead>
                    <tr>
            ...
            <table class="table table-hover table-striped table-bordered ViewData" data-export-title="<?php echo $this->lang->line('join_list'); ?>">
                ...
                <tbody>
                    ...
                    foreach ($viewerDetail as $viewer_key => $viewer_value) {
                        ...
                        ?>
                        <tr>
                            <td class="dt-body-left dt-head-left"><?php echo $viewer_value->admission_no; ?></td>
                            <td class=""><?php echo $this->customlib->getFullName($viewer_value->firstname,$viewer_value->middlename,$viewer_value->lastname,$sch_setting->middlename,$sch_setting->lastname) ?></td>
                            <td class=""><?php echo $viewer_value->father_name; ?></td>
