                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered example" data-export-title="<?php echo $this->lang->line('live_meeting_report');?>">
                                <thead>
                                    <tr>
                                        ...
                                        foreach ($meetingList as $meeting_key => $meeting_value) {
                                            ...
                                            <tr>
                                                <td class="mailbox-name">
                                                    <a href="#" data-toggle="popover" class="detail_popover"><?php echo $meeting_value->title; ?></a> </td>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    <button type="button" data-toggle="tooltip" class="btn btn-primary btn-xs viewer-list" id="load"  data-recordid="<?php echo $meeting_value->id; ?>" title="<?php echo $this->lang->line('join_list'); ?>" data-loading-text="<i class='fa fa-spinner fa-spin'></i>"><i class="fa fa-list"></i></button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
