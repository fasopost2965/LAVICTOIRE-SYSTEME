                    ...
                    foreach ($assignstudentlist as $key => $value) {
                        ...
                        <tr class="<?php echo $pointclass; ?>">
                            ...
                            <td class="mailbox-name text-right  ">
                                ...
                                <a href="#" class="btn btn-primary btn-xs delete_assign" data-student-id="<?php echo $value['student_id']; ?>" data-id="<?php echo $value['id']; ?>" title="" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php
