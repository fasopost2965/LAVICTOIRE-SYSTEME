        ...
        <thead>
            <tr class="white-space-nowrap">
                ...
                <th >
                    <table width="100%" >
                        <tr>
                            <td width="30%" valign="top" class="border0 pb5"><?php echo $this->lang->line('assigned_incident'); ?> </td>
                            <td width="60%" valign="top" class="border0 pb5"><?php echo $this->lang->line('description'); ?> </td>
                            <td width="10%" valign="top" class="border0 pb5 pl-lg-1"> <?php echo $this->lang->line('point'); ?> </td>
                        </tr>
                    </table>
                </th>
                        ...
                        <td> 
                            <table width="100%">
                                ...
                                <tr class="<?php echo $pointclass; ?>">
                                    <td width="30%" valign="top" class="border0 pb5"> 
                                        <?php echo $incident_value['title']; ?>
                                    </td>
                                    <td width="60%" valign="top" class="border0 pb5"> 
                                        <?php echo $incident_value['description']; ?>
                                    </td>
                                    <td width="10%" valign="top" class="border0 pb5 pl-lg-1"> 
