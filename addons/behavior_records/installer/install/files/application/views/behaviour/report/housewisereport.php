                ...
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('house_wise_rank_report');?>">
                                <thead>
                                    <tr>
                                        ...
                                        ?>
                                            <tr class="<?php echo $pointclass; ?>">
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="#" data-placement="top" data-house-id="<?php echo $housewise_value['school_houses_id']; ?>" data-toggle="modal" data-backdrop="static" class="btn btn-primary btn-xs assignstudent" title="" data-original-title="<?php echo $this->lang->line('show'); ?>"><i class="fa fa-reorder"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
