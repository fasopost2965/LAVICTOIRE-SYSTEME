                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <?php if(!empty($incidentlist)){ ?>
                            ...
                            <div class="modal-footer footer-fixed ">
                                <button type="submit" class="btn btn-primary" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i><?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('save'); ?></button>
                            </div>
