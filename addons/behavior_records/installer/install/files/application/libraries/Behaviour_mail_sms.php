...
class Behaviour_mail_sms
{
        ...
        if ($chk_mail_sms['mail'] or $chk_mail_sms['sms'] or $chk_mail_sms['notification'] or $chk_mail_sms['whatsapp']) {
            ...
            if (!empty($student_details)) {
                ...
                if ($student_sms_list && $chk_mail_sms['whatsapp'] &&  $chk_mail_sms['student_recipient']) {
                    $this->sentBehaviourIncidentAssignedstudentWhatsapp($student_sms_list, $chk_mail_sms);
                }
                if ($student_guardian_sms_list && $chk_mail_sms['whatsapp'] &&   $chk_mail_sms['guardian_recipient']) {
                    $this->sentBehaviourIncidentAssignedstudentWhatsapp($student_guardian_sms_list, $chk_mail_sms);
                }
                //============whatsapp=========//
            }
        }
    ...
    //============whatsapp=========//
    public function sentBehaviourIncidentAssignedstudentWhatsapp($sender_details, $chk_mail_sms)
    {
        $this->CI->load->library('whatsappgateway');
        foreach ($sender_details as $staff_key => $staff_value) {
            $send_to = $staff_key;
            $this->CI->whatsappgateway->sentBehaviourIncidentAssignedstudentWhatsapp($sender_details, $chk_mail_sms['template'], $send_to, $chk_mail_sms['whatsapp_template_id']);
        }
    }
    //============whatsapp=========//
