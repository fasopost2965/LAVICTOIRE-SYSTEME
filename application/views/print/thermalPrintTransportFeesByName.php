    ...
    <?php
				...
				<table width="100%" cellpadding="0" cellspacing="0" style="line-height: 11px;">	
                    ...
                    <tr>
                        ...
                        <td width="25%" class="text text-center"><?php $amount          = amountFormat($record->amount, 2,'.',''); echo (amountFormat($amount));?></td>
                        <td width="17%" class="text text-center"><?php $amount_discount = amountFormat($record->amount_discount, 2,'.','');echo (amountFormat($amount_discount));?>
                        </td>
                        <td width="17%" class="text text-right"><?php $amount_fine    = amountFormat($record->amount_fine, 2,'.','');echo (amountFormat($amount_fine));?></td>
                    </tr>					
