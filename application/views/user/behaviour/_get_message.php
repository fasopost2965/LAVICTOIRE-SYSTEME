        ...
        if($messagelist_value['type'] == 'staff'){  ?>
            <div class="d-flex justify-content-start mb-3-5">
                ...
                <div class="msg_cotainer">
                    <div class="media-title bolds"><?php echo $messagelist_value['staff_name'].' '.$messagelist_value['staff_surname'].$employee_id; ?> <?php 
                    if($superadmin_restriction == 'enabled') { 
                        echo " - ".$messagelist_value['role_name'];
                    }else{
                        if($messagelist_value['staff_role_id'] != 7){
                            echo " - ".$messagelist_value['role_name'];
                        }
                    } ?></div>
