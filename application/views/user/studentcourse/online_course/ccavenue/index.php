                               ...
                               <img src="<?php echo base_url(); ?>/uploads/course/course_thumbnail/<?php echo $params['course_thumbnail']; ?>" class="img-responsive center-block">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                    ...
                                    <tr class="paybtngray">
                                      ...
                                      <td><button type="submit" name="search" value="" class="btn btn-info pull-right buttondarkgray"><?php echo $this->lang->line('pay_with_ccavenue')?> <i class="fa fa-chevron-right valign-middle"></td>
                                  </tr>
                                </table>
                              </form>
                            </div>
