                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/payfast/pay" method="post">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td><a  onclick="delete_fee('<?php echo $fee_processing['id']; ?>')" title="delete processing fee" class="btn btn-defoult btn-sm"><i class="fa fa-remove"></i></a></td>
                                    </tr>
                                      <?php
                                    }?>
                                    <tr class="paybtngray">
                                      ...
                                      <td colspan="2"><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_payfast'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
