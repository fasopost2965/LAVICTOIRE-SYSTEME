                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                         <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo site_url('students/online_course/paypal/guestcomplete') ?>" method="POST" id="paypalForm">
...
$total_processing_charge += $value['gateway_processing_charge'];
                                  ...
                                  <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo $currency_symbol.amountFormat($cart_total+$total_processing_charge); ?></td>
                                    </tr>

                                    <input type="hidden" name="total_cart_amount" value="<?php echo $cart_total+$total_processing_charge; ?>">
                                    <input type="hidden" name="course_name" value="<?php echo $params[0]['guest_name']; ?>">
                                    <input type="hidden" name="guest_name" value="<?php echo $params[0]['guest_name']; ?>">
                                    <tr class="paybtngray">
                                      <td><button type="button" onclick="window.history.go(-1); return false;" name="search" value="" class="btn paybackbtn"><i class="fa fa-chevron-left"></i> <?php echo $this->lang->line('back')?></button></td>    
                                      <td class="text-right"><button type="submit" class="btn btn-info buttondarkgray"> <?php echo $this->lang->line('pay_with_paypal')?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                    </tr>
                                </table>   
                                </form> 
                            </div>
