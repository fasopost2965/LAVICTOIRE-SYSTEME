                ...
                <div class="paddtop20">
                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg pb0 paymentbg-width">
                            ...
                            <div class="">
                              <form action="<?php echo base_url(); ?>students/online_course/skrill/pay" method="post">
                                ...
                                <table class="table table-bordered table-hover mb0 paytable">
                                  ...
                                  <tr>
                                    ...
                                    <?php if(!empty($fee_processing)){
                                      ...
                                      <td class="text-right" >
                                       <label><?php echo $fee_processing['note']; ?></label>
                                      </td>
                                      <td class="text-right" >
                                       <a onclick="delete_fee('<?php echo $fee_processing['id']; ?>')" title="delete processing fee" class="btn btn-defoult btn-sm display-inline"> <i class="fa fa-remove"></i></a>
                                      </td>
                                    </tr>
                                      <?php
                                    }?>
                                    ...
                                    <tr class="paybtngray">
                                      ...
                                      <td colspan="2"><button type="submit"  name="search"  value="" class="btn btn-info buttondarkgray"><?php echo $this->lang->line('pay_with_skrill'); ?> <i class="fa fa-chevron-right valign-middle"></i></button></td>
                                  </tr>    
                                </table>
                                </form>
                            </div>
