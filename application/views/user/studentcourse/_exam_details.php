...
<div class="pagebg">
	<div class="row row-eq"> 
         <div class="col-md-12">
            <div class="box box-primary scroll-full-70">
...
?>
                  ...
                  <h4 class="text-center font-weight-bold"><?php  echo $exam->exam.($exam->is_quiz ? " (".$this->lang->line('quiz').")" : " (".$this->lang->line('exam').")"); ?></h4>
                    ...
                    <?php }else if($userdata["role"]=='guest'){ ?>
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="row">
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('name'); ?> </dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $guest_datails['guest_name']." (".$guest_datails['guest_unique_id']." )"; ?> </dd>
                              </div>
                           </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="row">
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('email'); ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $guest_datails['email']; ?></dd>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="row">
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('user_type'); ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line($userdata["role"]); ?> </dd>
                              </div>
                           </div>
                        </div>
                    <?php } ?>
                        ...
                        <dl class="row mb10">
                           <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                 ...
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                    <?php
                                        if(isset($exam->exam_from)){
                                            echo $this->customlib->dateyyyymmddToDateTimeformat($exam->exam_from, false);
                                        }else{ 
                                            echo "-"; 
                                        } ?>
                                  </dd>
                                 ...
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                    <?php 
                                        if(isset($exam->exam_to)){
                                            echo $this->customlib->dateyyyymmddToDateTimeformat($exam->exam_to, false); 
                                        }else{
                                            echo "-"; 
                                        }; ?>
                                  </dd>
                                 ...
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6">
                                 <?php if(isset($exam->auto_publish_date)){ echo $this->customlib->dateyyyymmddToDateTimeformat($exam->auto_publish_date, false);}else{ echo "-"; } ?>
                                  </dd>
                                <?php  }  ?>
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-12">
                              <div class="row">
                                 ...
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $question_type->total_quetions; ?></dd>
                                 <dt class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line('descriptive_questions') ?></dt>
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php  echo $question_type->total_descriptive; ?></dd>
                                 <?php
                   ...
                   <div class="row pb10">
                    ...
                    <?php
                    if(isset($exam->exam_to)){
                    if($submitstatus==0 && strtotime(date('Y-m-d H:i:s')) <= strtotime(date($exam->exam_to)) &&  strtotime(date('Y-m-d H:i:s')) >= strtotime(date($exam->exam_from))){ ?>
                        <div class="row no-print">
                            <div class="col-xs-12">
                                <button type="button" class="btn btn-info questions" data-recordid="<?php echo $exam->id; ?>"  data-course_id="<?php echo $exam->course_id; ?>"  data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa fa-bullhorn"></i> <?php echo $this->lang->line('start_exam') ?></button>
                            </div>
                        </div>
                    <?php } }else{
                        if($submitstatus==0 &&  strtotime(date('Y-m-d H:i:s')) >= strtotime(date($exam->exam_from))){ ?>
                        <div class="row no-print">
                            <div class="col-xs-12">
                                <button type="button" class="btn btn-info questions" data-recordid="<?php echo $exam->id; ?>"  data-course_id="<?php echo $exam->course_id; ?>"  data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><i class="fa fa-bullhorn"></i> <?php echo $this->lang->line('start_exam') ?></button>
                            </div>
                    ...
                    <?php }  } ?>
               <?php       
               if($submitstatus>0 && !$exam->publish_result){  ?>
                  <div class="row no-print">
                     <div class="col-xs-12">
            ...
            <?php   }   ?>  
<!-- =========================== start show quiz result============================ -->
<?php if($submitstatus>0 && $exam->publish_result){ ?>
...
if ($dispaly_negative_marks && $question_value->question_type != "descriptive") {
            ...
            ?>
                    ...
                    <p>
                              <b><?php echo $this->lang->line('tag_name') ?>:</b>
...
<div class="font-weight-bold"> <?php echo $this->lang->line('attachment') ?>: <a  href="<?php echo site_url('user/studentcourse/downloadattachment/' . $question_value->online_course_student_result_id); ?>"><?php echo $question_value->attachment_name; ?> <i class="fa fa-download"></i></a>
</div>
<?php } ?>

<?php if ($question_value->remark != "") {  ?>
                           <p>
...
<div class="questionmodal">
    <form id="regiration_form"  action=""  enctype="multipart/form-data" method="post">
         ...
         <div class="modal-dialog modal-dialogfullwidth">
            <div class="modal-content modal-contentfull">
               <div class="modal-header">
                  <button type="button" class="close questionclose" data-bs-dismiss="modal" aria-label="Close">&times;</button>
   ...
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-primary btn-ok" data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('save'); ?></button>
         </div>
      </div>
   </div>
</div>
  ...
  // $('#saveModal').on('click', '.btn-ok', function (e) {
   ...
   // });
	...
	$('#saveModal').on('click', '.btn-ok', function (e) {
        ...
        $.ajax({
            url: base_url + "user/studentcourse/check_storage",
            type: "POST",
            data: new FormData($('#regiration_form')[0]),
            processData: false,
            contentType: false,
	...
	// save and not refressh the page 
	$(".questionclose").on("click", function(){
		$("#onlineexample").modal("hide");
	});


	$("#regiration_form").on('submit', (function (e) {
    
        for (instance in CKEDITOR.instances) { //it will update textarea ckeditor value on submit by form
            CKEDITOR.instances[instance].updateElement();
        }

        e.preventDefault();
        let exam_id=<?php echo $exam->id;?>;
        $.ajax({
            url: "<?php echo site_url('user/studentcourse/savecourseexam') ; ?>",
            type: "POST",
            ...
            success: function (res){ 
                $("#onlineexample,#saveModal").modal("hide");
                $("#exam_"+exam_id).find('.exam_btn_id').click();
            },
...
<script>
    $(document).on('click', '.questions', function () {
       ...
       $.ajax({
           type: 'POST',
           url: baseurl + "user/studentcourse/getExamForm",
           data: {'recordid': recordid,'course_id':course_id},
           dataType: 'JSON',
           beforeSend: function () {
               $this.button('loading');
               clearInterval(interval);
