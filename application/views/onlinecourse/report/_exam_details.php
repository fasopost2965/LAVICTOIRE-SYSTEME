...
?>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-12">
                              <div class="row">
                                 ...
                                 <dd class="col-sm-6 col-xs-12 col-md-6 col-lg-6"><?php echo $this->lang->line($type); ?> </dd>
                              </div>
                           </div>
                        </div>
                ...
                <?php       
                if($submitstatus>0 && !$exam->publish_result){ // exam has been submitted by the student but result is not pubblished ?>
         ...
         <div class="modal-dialog modal-dialogfullwidth">
            ...
            <div class="modal-content modal-contentfull">
               <div class="modal-header">
				  <button type="button" class="close questionclose" data-dismiss="modal" onclick="clieseexammodal()">&times;</button>
