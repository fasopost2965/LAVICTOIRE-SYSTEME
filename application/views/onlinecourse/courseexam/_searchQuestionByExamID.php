    ...
    foreach ($questionList as $question_key => $question_value) {
        ...
        ?>
                 ...
                 <div class="row">
                    ...
                    <?php if ($this->rbac->hasPrivilege('online_course_add_questions_in_exam', 'can_edit')) {?>
                    ...
                    <?php echo readmorelink($question_value->question, site_url('onlinecourse/courseexamquestion/read/' . $question_value->id)); ?>
                    <div class="pt5">
        <div class="row">
