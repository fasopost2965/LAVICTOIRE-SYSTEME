...
<?php
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-striped table-bordered mintable-w900 example" data-export-title="<?php echo $this->lang->line('live_class'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%"><?php echo $this->lang->line('class'); ?></th>
...
<div class="modal fade" id="modal-online-timetable" data-backdrop="static"  role="dialog" aria-hidden="true" tabindex="-1">
