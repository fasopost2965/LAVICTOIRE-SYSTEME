...
if (!$timetable[$tm_key]) {
            ?>
                                                    ...
                                                    <div class="attachment-block clearfix">
                                                                <b class="text text-center"><?php echo $this->lang->line('not_scheduled'); ?><br>
                                                            </div>
                                                    <?php
} else {
    ...
    foreach ($gmeets as $gmeet_key => $gmeet_value) {
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-name" data-sort="<?php echo strtotime($gmeet_value->date); ?>"><?php echo $this->customlib->dateyyyymmddToDateTimeformat($gmeet_value->date); ?></td>
                                                ...
                                                <td class="mailbox-name">
                                                    ...
                                                    if ($gmeet_value->created_id == $logged_staff_id) {
                                                        ...
                                                        if($superadmin_visible == 'disabled' && $gmeet_value->role_id == 7){
                                                            ...
                                                            echo $gmeet_value->create_by_name . " " . $gmeet_value->create_by_surname." (". $gmeet_value->create_by_employee_id. ")";
                                                        }          
...
if ($gmeet_value->status == 0) {
            ?>
<a data-placement="top" href="<?php echo base_url();?>admin/gmeet/start/<?php echo $gmeet_value->id."/class"; ?>" class="btn label-success btn-xs start-mr-10"  target="_blank">
...
if ($gmeet_value->created_id == $logged_staff_id) {
            if ($this->rbac->hasPrivilege('gmeet_live_classes', 'can_delete')) {
                ?>
                                                        <a data-placement="top" href="<?php echo base_url(); ?>admin/gmeet/delete/<?php echo $gmeet_value->id; ?>"class="btn btn-primary btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                ...
                <div class="modal-body ">
                   ...
                   <div class="row">
                        ...
                        <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <label for="date"> <?php echo $this->lang->line('class_date_time') ?><small class="req"> *</small></label>
...
<div class="modal fade" id="modal-classteacher-timetable"  data-backdrop="static"  role="dialog" aria-hidden="true" style="z-index: 1050;">
    <div class="modal-dialog">
