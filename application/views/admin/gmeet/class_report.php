...
if (isset($liveclassList)) {
    ?>
                      <div class="box-header ptbnull"></div>
                        <div class="">
                            <div class="box-header with-border">
                                <h3 class="box-title titlefix"><?php echo $this->lang->line('live_class_report') ; ?></h3>

                            </div>
                            <div class="box-body">
							<div class="download_label"><?php echo $this->lang->line("live_class_report")?></div>
                                <?php
if (!empty($liveclassList)) {
        ?>
                                <table class="table table-hover table-striped table-bordered example" data-export-title="<?php echo $this->lang->line('live_class_report'); ?>">
                                <thead>
                                    <tr>
...
if (empty($liveclassList)) {
            ...
            foreach ($liveclassList as $liveclass_key => $liveclass_value) {
                ?>
                                            <tr>
                                                <td class="mailbox-name"><?php echo $liveclass_value->title; ?></td>
                                                <td class="mailbox-name"><?php echo $liveclass_value->description; ?></td>
                ...
                if ($liveclass_value->created_id == $logged_staff_id) {
                    ...
                    if($logged_staff_id == 7){ 
                        ...
                        if($superadmin_visible == 'disabled' && $liveclass_value->role_id == 7){
                            echo '';               
                        }else{
                            echo $liveclass_value->create_by_name . " " . $liveclass_value->create_by_surname . " (" . $liveclass_value->create_by_role_name . " : " . $liveclass_value->create_bystaffid . ")";   
                        }               
                ...
                ?>
                                                ...
                                                <button type="button" class="btn btn-primary btn-xs viewer-list" id="load" data-recordid="<?php echo $liveclass_value->id; ?>" data-class_id="<?php echo $class_id; ?>" data-section_id="<?php echo $section_id; ?>"  title="<?php echo $this->lang->line('join_list'); ?>" data-loading-text="<i class='fa fa-spinner fa-spin'></i>"><i class="fa fa-list"></i></button>
                                                </td>
                                            </tr>
                                            <?php
}
