...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #1a237e 0%, #3f51b5 100%); }
    ...
    <div class="container">
        <div class="form-box login">
            <form role="form" class="login-form" action="javascript:void(0);">
                ...
                <div class="notice-box">
                    <h4><i class='bx bx-help-circle'></i> Notice d'aide</h4>
                    <div style="margin-bottom: 5px;"><strong>FR:</strong> Entrez vos identifiants.</div>
                    <div style="margin-bottom: 5px;"><strong>EN:</strong> Enter your credentials.</div>
                    <div class="arabic-text"><strong>AR:</strong> أدخل بيانات الاعتماد الخاصة بك.</div>
                </div>
        ...
        <div class="toggle-box">
            <div class="toggle-panel toggle-left">
                <h1>Admin Portal</h1>
                <button class="btn login-btn">Back</button>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '.login-form', function(e) {
                ...
                $.ajax({
                    ...
                    error: () => alert("Erreur de connexion. Vérifiez l'URL: <?php echo site_url('gauthenticate/verfiy_login')?>"),
