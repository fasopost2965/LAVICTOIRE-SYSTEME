                    ...
                    <div class="box-body">                            
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <form action="<?php echo site_url('admin/gauthenticate/admin/verify_setup'); ?>" method="POST" class="verfiy_form">
                                    ...
                                    <button type="submit" name="search" value="verify-btn" class="btn btn-primary btn-sm"  data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('please_wait') ?>"> <?php echo $this->lang->line('verify_activate') ?></button>

                                </form>
                            </div>
                            <?php }else{  ?>
                            <div class="alert alert-info"><?php echo $this->lang->line('you_have_enabled_the_two_fa_method_if_you_want_to_remove_two_fa_account_please'); ?> 
                                <a href="#" class="displayinline align-text-top" data-addon-version="<?php echo $version;?>" data-addon="sstfa" data-toggle="modal" data-target="#confirm-delete-account"><?php echo $this->lang->line('click_here'); ?></a>
                            </div>
                            <?php } ?>
...
<script type="text/javascript">
    ...
    $('#confirm-delete-account').on('click', '.btn-ok', function(e) {
        ...
        $.ajax({
            url: baseurl+'admin/gauthenticate/admin/delete_setup',
            type: "POST",
            dataType: 'json',
            contentType: false,
            cache: false,
