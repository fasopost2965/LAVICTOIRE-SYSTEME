    ...
    <div class="container">
        <div class="form-box login">
            <form action="<?php echo site_url('site/userlogin') ?>" method="post">
                ...
                <div class="input-box">
                    <input type="text" name="username" placeholder="<?php echo $this->lang->line('username'); ?>" value="<?php echo set_value('username') ?>" id="email" required>
                    <i class='bx bxs-user'></i>
                    <span class="text-danger"><?php echo form_error('username'); ?></span>
                </div>
                <div class="input-box">
                    <input type="password" name="password" placeholder="<?php echo $this->lang->line('password'); ?>" value="<?php echo set_value('password') ?>" id="password" required>
        ...
        <div class="toggle-box">
            <div class="toggle-panel toggle-left">
                <h1>Bonjour !</h1>
                <p>Cliquez ici pour revenir à l'écran de connexion.</p>
                <button class="btn login-btn">Retour</button>
                
                <div class="instructions" style="margin-top: 40px; text-align: center;">
                    <p style="font-style: italic; opacity: 0.8;">Portail E-Victoire v2.0</p>
                </div>
            </div>
            <div class="toggle-panel toggle-right">
                <h1><?php echo $school['name']; ?></h1>
                <p>Portail Parents & Élèves</p>
                
                <div class="instructions">
                    <h4><i class='bx bx-info-circle'></i> Instructions</h4>
                    <ul style="list-style: none; padding: 0;">
                        <li style="margin-bottom: 10px;">
                            <strong>EN:</strong> Welcome to the Parent & Student Portal. Log in to track progress.
                        </li>
                        <li style="margin-bottom: 10px;">
                            <strong>FR:</strong> Bienvenue sur le portail Parents & Élèves. Connectez-vous pour suivre les progrès.
                        </li>
                        <li class="arabic-text" style="margin-bottom: 10px;">
                            <strong>AR:</strong> مرحبًا بكم في بوابة أولياء الأمور والطلاب. سجل الدخول للمتابعة.
                        </li>
                    </ul>
                </div>

                <button class="btn register-btn" style="margin-top: 20px;">Actualités</button>
            </div>
        </div>
    </div>
