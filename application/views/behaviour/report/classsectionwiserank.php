                ...
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                        <div class="mailbox-messages table-responsive overflow-visible-lg">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('class_section_wise_rank_report'); ?>">
                                <thead>
                                    <tr>
                                        <th class="dt-body-left dt-head-left"><?php echo $this->lang->line('rank'); ?></th>
                                    ...
                                    <?php } else {
                                        ...
                                        ?>
                                            <tr class="<?php echo $pointclass; ?>">
                                                <td class="mailbox-name dt-body-left dt-head-left"> <?php echo $rank; ?></td>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="#" data-class-id="<?php echo $classsectionwise_value['class_id']; ?>" data-section-id="<?php echo $classsectionwise_value['section_id']; ?>" data-toggle="modal" data-backdrop="static" class="btn btn-primary btn-xs assignstudent" title="" data-original-title="<?php echo $this->lang->line('show'); ?>"><i class="fa fa-reorder"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content modal-media-content mt35">
            <div class="modal-header">
                ...
                <a class="btn btn-default btn-xs pull-right mr-1 mt-5" id="print" title="<?php echo $this->lang->line('print'); ?>" onclick="printDiv()" ><i class="fa fa-print"></i></a>
                    <a class="btn btn-default btn-xs pull-right mt-5" id="btnExport" title="<?php echo $this->lang->line('excel'); ?>" onclick="fnExcelReport();"> <i class="fa fa-file-excel-o"></i> </a>
                <h4 class="box-title bmedium"><?php echo $this->lang->line('assigned_incident'); ?></h4>
            </div> 
            <div class="modal-body pt0 pb0 pl-1 pr5 relative clearboth mt-5 ">
