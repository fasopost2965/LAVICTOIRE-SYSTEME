                ...
                <div class="box removeboxmius">
                    ...
                    <div class="box-body">
                         <div class="table-responsive mailbox-messages overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('class_wise_rank_report');?>">
                                <thead>
                                    <tr>
                                        ...
                                        ?>
                                            <tr class="<?php echo $pointclass; ?>">
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    <a href="#" data-placement="top" data-class-id="<?php echo $classwiserank_value['class_id']; ?>" data-toggle="modal" data-backdrop="static" class="btn btn-primary btn-xs assignstudent" title="" data-original-title="<?php echo $this->lang->line('show'); ?>"><i class="fa fa-reorder"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
        ...
        <div class="modal-content modal-media-content ">		
			<div class="modal-header modal-media-header d-flex justify-content-between">
                ...
                <div class="pull-right d-flex align-items-center">				
                    <a class="btn btn-primary btn-xs pull-right " id="print" title="<?php echo $this->lang->line('print'); ?>" onclick="printDiv()" ><i class="fa fa-print"></i></a>
                    <a class="btn btn-primary btn-xs pull-right mr-1" id="btnExport" title="<?php echo $this->lang->line('excel'); ?>" onclick="fnExcelReport()"> <i class="fa fa-file-excel-o"></i> </a>
