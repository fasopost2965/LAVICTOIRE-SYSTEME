        ...
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header d-flex justify-content-between">
                ...
                <div class="pull-right d-flex align-items-center">    
                    <a class="btn btn-primary btn-xs" id="print" title="<?php echo $this->lang->line('print'); ?>" onclick="printDiv()" ><i class="fa fa-print"></i></a>
                    <a class="btn btn-primary btn-xs mr-1" id="btnExport" title="<?php echo $this->lang->line('excel'); ?>" onclick="fnExcelReport();"> <i class="fa fa-file-excel-o"></i> </a>
...
(function ($) {
  "use strict";
    new Chart(document.getElementById("doughnuts-chart"), {
        type: 'pie',
        data: {	  
		  labels: [<?php foreach ($incidentgraph as $value) { $title = strlen($value['title']) > 30 ? substr($value['title'], 0, 30).'...' : $value['title'];?>"<?php echo $title; ?>",<?php } ?>],
          datasets: [{
