...
<link rel="stylesheet" href="<?php echo base_url(); ?>backend/dist/css/custom_dashboard.css?v=<?php echo time(); ?>">
<script src="<?php echo base_url(); ?>backend/dist/js/custom_dashboard.js?v=<?php echo time(); ?>"></script>
    </head>
    <script>
         var baseurl = "<?php echo base_url(); ?>";
    </script>
...
$role = isset($student_session['role']) ? $student_session['role'] : ''; 
...
$ntf = $this->customlib->getUserunreadNotification();
        ...
        ?>
                ...
                <?php } else$student_session = $this->session->userdata('student'); 
$role = isset($student_session['role']) ? $student_session['role'] : ''; 
$function = 'user/user/dashboard';
if ($role == 'guest') {?>
