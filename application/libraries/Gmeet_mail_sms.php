...
class Gmeet_mail_sms
{
        ...
        if ($chk_mail_sms['mail'] or $chk_mail_sms['sms'] or $chk_mail_sms['notification'] or $chk_mail_sms['whatsapp']) {
            ...
            if (!empty($student_list)) {
                ...
                if ($student_sms_list && $chk_mail_sms['whatsapp'] &&  $chk_mail_sms['student_recipient']) {
                    $this->sentstudentOnlineClasswhatsapp($student_sms_list, $chk_mail_sms);
                }

                if ($student_guardian_sms_list && $chk_mail_sms['whatsapp'] &&   $chk_mail_sms['guardian_recipient']) {
                    $this->sentstudentOnlineClasswhatsapp($student_guardian_sms_list, $chk_mail_sms);
                }
                //whatsapp//
            }
        }
        ...
        if ($chk_mail_sms['mail'] or $chk_mail_sms['sms']  or $chk_mail_sms['whatsapp']) {
            ...
            if (!empty($staff_details)) {
                ...
                foreach ($staff_details as $staff_key => $staff_value) {
                    ...
                    if ($staff_value['contact_no'] != "" && $chk_mail_sms['staff_recipient']) { //contact for sms and whatsapp msg
                ...
                //whatsapp//
                if ($staff_sms_list && $chk_mail_sms['whatsapp_template_id'] != "" && $chk_mail_sms['whatsapp']) {
                    $this->sentOnlineMeetingStaffwhatsapp($staff_sms_list, $chk_mail_sms);
                }
                //whatsapp//
            }
        }
    ...
    //====================Whatsapp=======================//
    public function sentOnlineMeetingStaffwhatsapp($sender_details, $chk_mail_sms)
    {
        $this->CI->load->library('whatsappgateway');
        foreach ($sender_details as $staff_key => $staff_value) {
            $send_to = $staff_key;
            $this->CI->whatsappgateway->sentOnlineMeetingStaffwhatsapp($sender_details, $chk_mail_sms['template'], $send_to, $chk_mail_sms['whatsapp_template_id']);
        }
    }

    public function sentstudentOnlineClasswhatsapp($sender_details, $chk_mail_sms)
    {
        $this->CI->load->library('whatsappgateway');
        foreach ($sender_details as $staff_key => $staff_value) {
            $send_to = $staff_key;
            $this->CI->whatsappgateway->sentstudentOnlineClasswhatsapp($sender_details, $chk_mail_sms['template'], $send_to, $chk_mail_sms['whatsapp_template_id']);
        }
    }
    //====================Whatsapp=======================//
