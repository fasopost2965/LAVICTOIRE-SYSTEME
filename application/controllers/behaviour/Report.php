    ...
    public function dtstudentlist($session=null)
    {
        ...
        if (!empty($students->data)) {
            foreach ($students->data as $student_key => $student) {
                ...
                $viewbtn = "<a href='#' data-placement='top' data-student-id=".$student->id." data-session-value=".$session_value." data-toggle='modal' data-backdrop='static' class='btn btn-primary btn-xs assignstudent'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa fa-reorder'></i></a>";
    ...
    public function dtstudentranklist()
    {
        ...
        if (!empty($result)) {  $totalpoints =''; $rank =0;
            foreach ($result as $rank_key => $value) {          
                ...
                $viewbtn = "<a href='#' data-placement='top' data-student-id=".$value->id." data-session-value=".$session_value." data-toggle='modal' data-backdrop='static' class='btn btn-primary btn-xs assignstudent'  data-toggle='tooltip' title='" . $this->lang->line('show') . "'><i class='fa fa-reorder'></i></a>";
                ...
                $row[] = "<div class='d-flex gap-0-5 text-right float-right'>".$viewbtn."</div>";
