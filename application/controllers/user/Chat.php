...
class Chat extends Student_Controller
{
    ...
    public function index()
    {
        ...
        $user_type = isset($student_session['role']) ? $student_session['role'] : '';
    ...
    public function get_student_parent_chat_msg_count(){
        $session_data = $this->session->userdata('student');
        $user_type = isset($session_data['role']) ? $session_data['role'] : '';
