<?php
/**
 * Extraction and Classification of the last legacy class (6??me -> 7??me Coll??ge)
 */
...
// 1. Fetch Students (Session 21, Class 1)
...
// 3. Generate CSVs with A/B Distribution
$files = [
    'LEGACY_750' => fopen('LAST_LEGACY_750.csv', 'w'),
    'STANDARD_900' => fopen('LAST_STANDARD_900.csv', 'w'),
    'A_VERIFIER' => fopen('LAST_A_VERIFIER.csv', 'w')
];
...
$i = 0;
foreach ($students as $student) {
    // A/B Distribution (27 = 7eme-A, 28 = 7eme-B)
    $class_section_id = ($i % 2 == 0) ? 27 : 28;
