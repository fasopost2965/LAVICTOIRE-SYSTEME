<?php
/**
 * Final Asset Generation for CM1 Migrated Students
 * Uses chillerlan/php-qrcode and Zend_Barcode
 */
...
// Fetch students
$res = $conn->query("SELECT id, admission_no FROM students WHERE id >= 111");
