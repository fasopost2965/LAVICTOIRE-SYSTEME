...
async function initialize(event) {
    ...
    const { paymentIntentId, clientSecret } = await fetch(baseurl+'students/online_course/stripe/guest_create_payment_intent', {
        method: "POST",
...
async function handlePaymentSubmit(e) {
    ...
    const { customer_id } = await fetch(baseurl+"students/online_course/stripe/guest_create_customer", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    if (paymentIntent) {
        switch (paymentIntent.status) { 
            case "succeeded":
                ...
                fetch(baseurl+"students/online_course/stripe/guest_insert_payment", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
