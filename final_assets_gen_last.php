<?php
/**
 * Final Asset Generation for 7??me Coll??ge Migrated Students
 */
...
// Fetch students with IDs 149 to 187
$res = $conn->query("SELECT id, admission_no FROM students WHERE id >= 149");
